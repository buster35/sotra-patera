...
window.prompt("Welcome to the random password generator engine"); //object.method not currently attached to anything; we want it to do something. Put it in a function?//
...
function writePassword() {
  ...
  passwordText.value = password; //this is updated the passwordText variable to
}
